...
$GLOBALS['TL_DCA']['tl_settings']['palettes']['default'] = str_replace('{files_legend', '{qbwc_legend}, qbwc_username, qbwc_password, last_run;{files_legend', $GLOBALS['TL_DCA']['tl_settings']['palettes']['default']);
